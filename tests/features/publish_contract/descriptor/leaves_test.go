...
func TestEnum_AceitaValorDoConjunto(t *testing.T) {
	subject := descriptor.Enum{Code: "schema.invalid_type", Allowed: []string{"object", "array"}}
...
func TestEnum_JulgaEscalarPeloTexto(t *testing.T) {
	subject := descriptor.Enum{Code: "schema.invalid_type", Allowed: []string{"object", "200"}}
...
func TestEnum_RejeitaMapeamentoComoKind(t *testing.T) {
	subject := descriptor.Enum{Code: "schema.invalid_type", Allowed: []string{"object"}}
